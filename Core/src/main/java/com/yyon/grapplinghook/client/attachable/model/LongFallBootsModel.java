...
public class LongFallBootsModel<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public static MeshDefinition createBodyLayer() {
        CubeDeformation outerArmourDeform = new CubeDeformation(1.01f);
        ...
        rightLeg.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(0, 16)
                        .addBox(0, -1.0f, 3, 1, 7, 3, outerArmourDeform.extend(-0.2f)),
                PartPose.offsetAndRotation(-0.7f, 7.5f, -2.0f, 0.523599f, 0, 0)
        );
        leftLeg.addOrReplaceChild(
                ...
                CubeListBuilder.create()
                        .texOffs(0, 16)
                        .addBox(0, -1.0f, 3, 1, 7, 3, outerArmourDeform.extend(-0.2f)),
                PartPose.offsetAndRotation(-0.3f, 7.5f, -2.0f, 0.523599f, 0f, 0f)
        );
