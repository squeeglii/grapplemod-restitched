...
public class GrappleModCustomizationCategories {
    ...
    public static <P extends CustomizationCategory> P category(String id, Supplier<P> type) {
    ...
    public static final CustomizationCategory LIMITS = category("limits", () -> new CustomizationCategory(
            GrappleModItems.LIMITS_UPGRADE.get()
    ));

    public static final CustomizationCategory ROPE = category("rope", () -> new CustomizationCategory(
    ...
    public static final CustomizationCategory HOOK_THROWER = category("hook_thrower", () -> new CustomizationCategory(
    ...
    public static final CustomizationCategory MOTOR = category("motor", () -> new CustomizationCategory(
    ...
    public static final CustomizationCategory SWING = category("swing", () -> new CustomizationCategory(
            GrappleModItems.SWING_UPGRADE.get(),
            MOVE_SPEED_MULTIPLIER.get()
    ));

    public static final CustomizationCategory ENDER_STAFF = category("ender_staff", () -> new CustomizationCategory(
            GrappleModItems.ENDER_STAFF_UPGRADE.get(),
            ENDER_STAFF_ATTACHED.get()
    ));

    public static final CustomizationCategory FORCEFIELD = category("forcefield", () -> new CustomizationCategory(
            GrappleModItems.FORCE_FIELD_UPGRADE.get(),
            FORCEFIELD_ATTACHED.get(), FORCEFIELD_FORCE.get()
    ));

    public static final CustomizationCategory MAGNET = category("magnet", () -> new CustomizationCategory(
            GrappleModItems.MAGNET_UPGRADE.get(),
            MAGNET_ATTACHED.get(), MAGNET_RADIUS.get()
    ));

    public static final CustomizationCategory DOUBLE_HOOK = category("double_hook", () -> new CustomizationCategory(
    ...
    public static final CustomizationCategory ROCKET = category("rocket", () -> new CustomizationCategory(
