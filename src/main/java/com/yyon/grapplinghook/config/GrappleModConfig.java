...
public class GrappleModConfig implements ConfigData {
	...
	public static Config getConf() {
		if (serverOptions == null) {
			return AutoConfig.getConfigHolder(GrappleModConfig.class).getConfig().options;
		} else {
	...
	public static ClientConfig getClientConf() {
		return AutoConfig.getConfigHolder(GrappleModConfig.class).getConfig().clientOptions;
	}
}
